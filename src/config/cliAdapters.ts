...
export const cliAdapterDefinitions: CLIAdapterDefinition[] = [
  ...
  },
  {
    ...
    toolSessionArgPrefixes: [],
    installHint:
      "npm install -g --include=optional --ignore-scripts @deepseek-ai/dsh-acp-demo@next @deepseek-ai/dsh-bash-sandbox@next @deepseek-ai/dsh-compaction-basic@next @deepseek-ai/dsh-fs-observation-policy@next @deepseek-ai/dsh-fs-sandbox@next @deepseek-ai/dsh-llm-deepseek@next @deepseek-ai/dsh-sandbox-local@next @deepseek-ai/dsh-sandbox-policy@next @deepseek-ai/dsh-session-projection@next @deepseek-ai/dsh-subprocess-local@next @deepseek-ai/dsh-token-meter@next @deepseek-ai/dsh-tool-fs@next @deepseek-ai/dsh-tool-todo@next @deepseek-ai/dsh-user-approval@next",
