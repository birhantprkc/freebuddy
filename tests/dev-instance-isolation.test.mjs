...
test("main.ts and App.tsx show dev badge and isolate userData in dev mode", () => {
  ...
  assert.match(app, /document\.title\s*=\s*"FreeBuddy \[DEV\]"/);
  assert.match(app, /sidebar-dev-badge/);
  assert.match(css, /\.sidebar-dev-badge/);
});
